...
export class RecipeListComponent {
  public recipes: Recipe[] = [
    ...
    new Recipe("Buldak Ramyun", "Buldak Ramyun is a popular instant noodles product!", "https://www.chilipeppermadness.com/wp-content/uploads/2023/01/Buldak-Ramen-SQ-500x500.jpg")
  ];
